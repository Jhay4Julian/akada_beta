...
import 'package:akada_beta/screens/bottom_navbar.dart';
import 'package:akada_beta/screens/homepage.dart';
import 'package:akada_beta/screens/onboarding/register.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        padding:
                            EdgeInsets.only(left: 40.0, top: 10.0, right: 40.0),
                        child: TextField(
                          style: TextStyle(color: Colors.black),
                          decoration: InputDecoration(
                              border: OutlineInputBorder(),
